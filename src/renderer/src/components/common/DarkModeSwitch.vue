  ...
  return [
    {
      label: t('app.lignt'),
      value: 'light',
      icon: renderIcon('icon-park-outline:sun-one')//IconSun,
    },
    {
      label: t('app.dark'),
      value: 'dark',
      icon: renderIcon('icon-park-outline:moon')//IconMoon,
    },
    {
      label: t('app.system'),
      value: 'auto',
      icon: renderIcon('icon-park-outline:laptop-computer')//IconAuto,
    },
  ]
})
